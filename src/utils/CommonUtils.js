...
var CommonUtils = {
    ...
    loadCommon: function (callback) {
        this.appendLink('/src/assets/css/common/Common.css?t=20200909');
        this.appendLink('/src/assets/css/common/Dialog.css?t=20200909');
        this.appendScript('/src/third/jquery/Jquery-2.1.1.min.js', callback);
        this.appendScript('/src/config/Index.js?t=20200909');
        this.appendScript('/src/utils/crypto-js.min.js');
        this.appendScript('/src/utils/AjaxUtils.js?t=20200909');
        this.appendScript('/src/utils/DialogUtils.js?t=20200909');
    },
    /**
     添加link资源
    ...
    */
    ...
    /**
        ...
        @return
    */
    resetRem: function(screenW) {
        if (screenW == undefined) {
            screenW = 375
        }
        var resetRem = function() {
            var w = document.documentElement.clientWidth||document.body.innerWidth
            document.documentElement.style.fontSize = w / screenW * 100 + 'px'
        }
        resetRem()
    ...
    */
    ...
    /**
        ...
        @param {Array} urlArr 图片组
        @return
     */
    lookImg: function(url, urlArr) {
        sessionStorage.lookImgs = JSON.stringify(urlArr)
        Router.jump('imgLook', '?url='+url)
    },
    /**
        获取requestApp
        @param {String} defaultVal 默认值
        @return {Array} 获取requestApp
     */
    getRequestApp: function(defaultVal) {
        var requestApp = CommonUtils.getCookie("requestApp")
        return this.isEmpty(requestApp) ? defaultVal : requestApp
    },
    /**
        获取requestClient
        @param {String} defaultVal 默认值
        @return {Array} 获取requestApp
     */
    getRequestClient: function(defaultVal) {
        var requestClient = CommonUtils.getCookie("requestClient")
        return this.isEmpty(requestClient) ? defaultVal : requestClient
    }
}